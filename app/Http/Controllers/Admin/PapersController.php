...
class PapersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $assigns = \App\User::get()->pluck('name', 'id');
$fullpapers = \App\Fullpaper::where('paper_id', $id)->get();$messages = \App\Message::where('paper_id', $id)->get();$reviews = \App\Review::where('paper_id', $id)->get();

        $paper = Paper::findOrFail($id);

        return view('admin.papers.show', compact('paper', 'fullpapers', 'messages', 'reviews'));
    }
